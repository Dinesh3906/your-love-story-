    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed bottom-24 right-20 sm:bottom-8 sm:right-24 z-[100] p-4 sm:p-4 rounded-full glass-morphism border border-cherry-blossom/60 text-white shadow-[0_0_30px_rgba(255,183,197,0.4)] hover:shadow-[0_0_40px_rgba(255,183,197,0.6)] transition-all group overflow-hidden"
            ...
            <motion.button
                ...
                className="fixed bottom-24 right-6 sm:bottom-8 sm:right-8 z-[100] p-4 sm:p-4 rounded-full glass-morphism border border-white/20 text-white shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] transition-all group overflow-hidden"
