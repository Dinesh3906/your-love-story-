...
export const MusicControls = () => {
    ...
    return (
        <motion.button
            ...
            className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-[100] p-3 sm:p-4 rounded-full glass-morphism border border-white/20 text-white/80 hover:text-white transition-all shadow-lg group overflow-hidden"
