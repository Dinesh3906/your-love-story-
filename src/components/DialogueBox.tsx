...
export default function DialogueBox({ speaker, text, onComplete }: Props) {
  ...
  return (
    <motion.div
      ...
      className="glass-morphism rounded-[24px] sm:rounded-[48px] p-6 sm:p-12 lg:p-14 shadow-2xl relative z-10 neon-border"
    >
      ...
      <AnimatePresence mode="wait">
        {speaker && (
          <motion.div
            ...
            className="absolute -top-7 sm:-top-10 left-8 sm:left-14 py-2 sm:py-4 px-6 sm:px-12 bg-gradient-to-r from-cherry-blossom via-cherry-light to-cherry-blossom bg-[length:200%_auto] rounded-full z-40 shadow-2xl shadow-cherry-blossom/40 border border-white/10"
      ...
      <div className="relative pt-4 sm:pt-8">
        <div className="min-h-[80px] sm:min-h-[120px] lg:min-h-[160px] max-h-[40vh] overflow-y-auto custom-scrollbar pr-4 sm:pr-8">
          <p className="text-white/95 text-lg sm:text-2xl lg:text-4xl font-serif leading-[1.6] tracking-wide selection:bg-cherry-blossom/30 italic font-light drop-shadow-sm">
            {displayText}
      ...
      <div className="flex justify-end mt-6 sm:mt-14">
        <motion.button
